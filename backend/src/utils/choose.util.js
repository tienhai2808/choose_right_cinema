...
module.exports.getGeminiRecommendation = async (cinemas, film, date) => {
  ...
  Trong ảnh suất chiếu, nếu ngày chiếu trùng với ngày hiện tại, hãy bỏ qua các suất chiếu trước thời gian hiện tại. 
  Nếu ngày chiếu KHÁC ngày hiện tại (ví dụ ngày mai), hãy giữ tất cả các suất chiếu trong ngày đó để phân tích.
